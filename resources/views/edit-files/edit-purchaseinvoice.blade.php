    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Edit Purchase Invoice</h4>
                                ...
                                <div class="form-row">
                                    <div class="col-sm-6"><label for="orderid" class="caption">Bill No </label>
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="orderid" value="{{ $purchaseInvoice->orderid }}"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"><label for="challanno" class="caption">Challan No </label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-bookmark-o"
                                                    aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" value="{{ $purchaseInvoice->challannum }}"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="input-daterange input-group" data-date-format="yyyy-mm-dd"
                                        ...
                                        <input type="text" class="form-control" name="orderdate"
                                            value="{{ $purchaseInvoice->orderdate }}" autocomplete="off" />
                                        <input type="text" class="form-control" name="orderduedate"
                                            value="{{ $purchaseInvoice->orderduedate }}" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" name="notes" rows="2"
                                            placeholder="Enter Description For Invoice">{{ $purchaseInvoice->notes }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
